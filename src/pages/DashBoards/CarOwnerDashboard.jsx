...
const CarOwnerDashboard = () => {
  ...
  const handleRideSubmit = async (e) => {
    ...
    try {
      ...
      const distanceKm = rideForm.distanceKm ? parseFloat(rideForm.distanceKm) : 10; // Default 10km if not provided
                  ...
                  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4 max-h-screen overflow-y-auto">
                      <div className="flex justify-between items-center mb-4">
                        <h3 className="text-lg font-semibold">Post New Ride</h3>
                        <button
