...
const UserDashboard = () => {
  ...
  const handleSearchSubmit = async (e) => {
    ...
    try {
      ...
      const hasSearchParams =
        ...
        searchParams.rideDate;
      const rides = hasSearchParams
        ? await ridesAPI.searchRides(searchParams)
        : showExpiredRides
        ? await ridesAPI.getAllRides()
        : await ridesAPI.getActiveRides();
      ...
      try {
        ...
        const allRides = showExpiredRides
          ? await ridesAPI.getAllRides()
          : await ridesAPI.getActiveRides();
  ...
  const handleBookRide = (ride) => {
    ...
    if (isRideExpired(ride.rideDate, ride.rideTime)) {
      showNotification(
        "This ride has already completed. You cannot book expired rides.",
        "error"
      );
      return;
    }
            ...
            <div className="p-6">
                  ...
                  <div>
                    ...
                    {loading ? (
                      <div className="flex justify-center items-center py-12">
                        <CarLoader size={120} text="Searching for rides..." />
                      </div>
              ...
              {activeTab === "bookings" && (
                <div>
                  ...
                  {loading ? (
                    <div className="flex justify-center items-center py-12">
                      <CarLoader size={120} text="Loading your bookings..." />
                    </div>
                  ) : myBookings.length === 0 ? (
                    <div className="text-center py-12">
                      <svg
                        ...
                        >
                          <div className="flex justify-between items-start">
                            ...
                            <div className="ml-6 text-right">
                              ...
                              {/* Show cancel button for CONFIRMED and PENDING bookings that haven't expired */}
                              {(booking.status === "CONFIRMED" ||
                              ...
                              {/* Show completion status for expired rides */}
                              {isRideExpired(
                                booking.rideDate,
                                booking.rideTime
                              ) && (
